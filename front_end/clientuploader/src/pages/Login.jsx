...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    console.log("🌐 Redirigiendo login con Google a:", redirectTo);
    ...
    if (error) {
      ...
      console.log("📡 Redirección iniciada con Google:", data);
    }
  };
  ...
  const initializeUser = async (user) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error("❌ Error al inicializar usuario");
